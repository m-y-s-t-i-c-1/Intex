...
//         ,
//         // Каркасные бассейны (adăugate de utilizator)
...
// // Utility: ensure productListContainer includes a subcategory container when needed
// function ensureSubcategoryContainer() {
//     const container = document.getElementById('productListContainer');
//     if (!container) return null;
//     let sub = document.getElementById('subcategoryContainer');
//     if (!sub) {
//         sub = document.createElement('div');
//         sub.id = 'subcategoryContainer';
//         sub.className = 'subcategory-wrapper';
//         sub.style.display = 'grid';
//         sub.style.gridTemplateColumns = 'repeat(auto-fit, minmax(200px, 1fr))';
//         sub.style.gap = '12px';
//         sub.style.margin = '12px 0';
//         // insert subcategory container above the product grid if possible
//         const grid = document.getElementById('productListGrid');
//         if (grid) container.insertBefore(sub, grid);
...
//     const subContainer = ensureSubcategoryContainer();
...
//     // hide product grid while showing subcategories
//     if (productListGrid) productListGrid.style.display = 'none';
...
//             + '                    <p style="margin:6px 0 0 0; color:#666; font-size:0.9rem;">' + (sub.count ? '('+sub.count+')' : '') + '</p>\n'
//             + '                </div>\n'
//             + '                <div style="align-self:center; font-size:1.2rem;">›</div>\n'
//             + '            </div>\n';
//         card.addEventListener('click', function(){ showSubcategory(categoryId, sub.id, sub.title); });
//         subContainer.appendChild(card);
//     });
// }

// function showSubcategory(categoryId, subId, subTitle) {
//     // set current state
//     currentCategory = categoryId;
//     currentSubcategory = subId;
//     const lang = (typeof getCurrentLang === 'function') ? getCurrentLang() : 'ro';
//     currentFilteredProducts = PRODUCTS_DATA.filter(function(p){ return p.category === categoryId && p.subcategory === subId; });
//     currentPage = 1;

//     // Update title
//     if (currentCategoryTitle) currentCategoryTitle.innerText = subTitle || subId;

//     // hide subcategories (keep them available if user goes back to category)
//     const subContainer = document.getElementById('subcategoryContainer');
//     if (subContainer) subContainer.style.display = 'none';

//     // show product grid
//     if (productListGrid) productListGrid.style.display = '';
//     // show product list
...
//     // push navigation state: viewing products for a subcategory
//     pushState({ view: 'products', category: categoryId, subcategory: subId, page: 1 });

//     renderPaginatedGrid();
// }

// // When showing the top-level products for 'boats', first show subcategories as cards


// const PRODUCTS_DATA = [
//     // NOTE: subcategory property added for several 'boats' products to demonstrate filtering.
...
//     // transport copii (exemplu mic)
//     // --- TRANSPORT (Trotinete, Skateboard-uri, Role) ---
//     { 
//         id: 't1', 
//         category: 'transport', 
//         title: { ro: "Tricicletă pentru copii", ru: "Детский трехколесный велосипед", en: "Kids Tricycle" }, 
//         price: 1799, oldPrice: null, image: '../assets/img/transport1.jpg' 
//     },
//     { 
//         id: 't2', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii Model 188", ru: "Детский самокат 188", en: "Kids Scooter 188" }, 
//         price: 500, oldPrice: null, image: '../assets/img/scooter-188.jpg' 
//     },
//     { 
//         id: 't3', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 2206", ru: "Скейтборд 2206", en: "Kids Skateboard 2206" }, 
//         price: 399, oldPrice: null, image: '../assets/img/skate-2206.jpg' 
//     },
//     { 
//         id: 't4', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 2308", ru: "Скейтборд 2308", en: "Kids Skateboard 2308" }, 
//         price: 450, oldPrice: null, image: '../assets/img/skate-2308.jpg' 
//     },
//     { 
//         id: 't5', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 2406", ru: "Скейтборд 2406", en: "Kids Skateboard 2406" }, 
//         price: 399, oldPrice: null, image: '../assets/img/skate-2406.jpg' 
//     },
//     { 
//         id: 't6', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 2489", ru: "Детский самокат 2489", en: "Kids Scooter 2489" }, 
//         price: 570, oldPrice: null, image: '../assets/img/scooter-2489.jpg' 
//     },
//     { 
//         id: 't7', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 28p", ru: "Скейтборд 28p", en: "Kids Skateboard 28p" }, 
//         price: 500, oldPrice: null, image: '../assets/img/skate-28p.jpg' 
//     },
//     { 
//         id: 't8', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 306", ru: "Детский самокат 306", en: "Kids Scooter 306" }, 
//         price: 450, oldPrice: null, image: '../assets/img/scooter-306.jpg' 
//     },
//     { 
//         id: 't9', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 307", ru: "Детский самокат 307", en: "Kids Scooter 307" }, 
//         price: 450, oldPrice: null, image: '../assets/img/scooter-307.jpg' 
//     },
//     { 
//         id: 't10', 
//         category: 'transport', 
//         title: { ro: "Skateboard cu mâner 3108", ru: "Скейтборд с ручкой 3108", en: "Handle Skateboard 3108" }, 
//         price: 650, oldPrice: null, image: '../assets/img/skate-3108-handle.jpg' 
//     },
//     { 
//         id: 't11', 
//         category: 'transport', 
//         title: { ro: "Skateboard cu roți luminoase 3108", ru: "Скейтборд со светящимися колесами 3108", en: "Glowing Wheels Skateboard 3108" }, 
//         price: 500, oldPrice: null, image: '../assets/img/skate-3108-glow.jpg' 
//     },
//     { 
//         id: 't12', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 3108GD", ru: "Скейтборд 3108GD", en: "Kids Skateboard 3108GD" }, 
//         price: 650, oldPrice: null, image: '../assets/img/skate-3108gd.jpg' 
//     },
//     { 
//         id: 't13', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 3108K", ru: "Скейтборд 3108K", en: "Kids Skateboard 3108K" }, 
//         price: 650, oldPrice: null, image: '../assets/img/skate-3108k.jpg' 
//     },
//     { 
//         id: 't14', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 518", ru: "Детский самокат 518", en: "Kids Scooter 518" }, 
//         price: 600, oldPrice: null, image: '../assets/img/scooter-518.jpg' 
//     },
//     { 
//         id: 't15', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 601", ru: "Детский самокат 601", en: "Kids Scooter 601" }, 
//         price: 530, oldPrice: null, image: '../assets/img/scooter-601.jpg' 
//     },
//     { 
//         id: 't16', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 618", ru: "Детский самокат 618", en: "Kids Scooter 618" }, 
//         price: 550, oldPrice: null, image: '../assets/img/scooter-618.jpg' 
//     },
//     { 
//         id: 't17', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 619", ru: "Детский самокат 619", en: "Kids Scooter 619" }, 
//         price: 599, oldPrice: null, image: '../assets/img/scooter-619.jpg' 
//     },
//     { 
//         id: 't18', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 620", ru: "Детский самокат 620", en: "Kids Scooter 620" }, 
//         price: 699, oldPrice: null, image: '../assets/img/scooter-620.jpg' 
//     },
//     { 
//         id: 't19', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 628-2", ru: "Детский самокат 628-2", en: "Kids Scooter 628-2" }, 
//         price: 799, oldPrice: null, image: '../assets/img/scooter-628-2.jpg' 
//     },
//     { 
//         id: 't20', 
//         category: 'transport', 
//         title: { ro: "Trotinetă Model 6616", ru: "Самокат 6616", en: "Scooter 6616" }, 
//         price: 450, oldPrice: null, image: '../assets/img/scooter-6616.jpg' 
//     },
//     { 
//         id: 't21', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 801", ru: "Детский самокат 801", en: "Kids Scooter 801" }, 
//         price: 550, oldPrice: null, image: '../assets/img/scooter-801.jpg' 
//     },
//     { 
//         id: 't22', 
//         category: 'transport', 
//         title: { ro: "Skateboard copii 808", ru: "Скейтборд 808", en: "Kids Skateboard 808" }, 
//         price: 599, oldPrice: null, image: '../assets/img/skate-808.jpg' 
//     },
...
//         id: 'r1', 
//         category: 'transport', 
//         title: { ro: "Role Negre L (39-42) - 9087", ru: "Ролики Blak-L (39-42) 9087", en: "Black Rollerblades L (39-42)" }, 
//         price: 650, oldPrice: null, image: '../assets/img/role-9087-black.jpg' 
//     },
//     { 
//         id: 'r2', 
//         category: 'transport', 
//         title: { ro: "Role Albastre M (35-38) - 9087", ru: "Ролики Blue-M (35-38) 9087", en: "Blue Rollerblades M (35-38)" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9087-blue.jpg' 
//     },
//     { 
//         id: 'r3', 
//         category: 'transport', 
//         title: { ro: "Role Albastre S (31-34) - 9087", ru: "Ролики Blue-S (31-34) 9087", en: "Blue Rollerblades S (31-34)" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9087-blue.jpg' 
//     },
//     { 
//         id: 'r4', 
//         category: 'transport', 
//         title: { ro: "Role Roz M (35-38) - 9087", ru: "Ролики PINK-M (35-38) 9087", en: "Pink Rollerblades M (35-38)" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9087-pink.jpg' 
//     },
//     { 
//         id: 'r5', 
//         category: 'transport', 
//         title: { ro: "Role Roz S (31-34) - 9087", ru: "Ролики PINK-S (31-34) 9087", en: "Pink Rollerblades S (31-34)" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9087-pink.jpg' 
//     },
//     { 
//         id: 'r6', 
//         category: 'transport', 
//         title: { ro: "Role Roz S (31-34) - 963", ru: "Ролики PINK-S (31-34) 963", en: "Pink Rollerblades S (31-34) 963" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-963-pink.jpg' 
//     },
//     { 
//         id: 'r7', 
//         category: 'transport', 
//         title: { ro: "Role Roz M (35-38) - 9807", ru: "Ролики PINK-M (35-38) 9807", en: "Pink Rollerblades M (35-38) 9807" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9807-pink.jpg' 
//     },
//     { 
//         id: 'r8', 
//         category: 'transport', 
//         title: { ro: "Role Roz S (31-34) - 9807", ru: "Ролики PINK-S (31-34) 9807", en: "Pink Rollerblades S (31-34) 9807" }, 
//         price: 850, oldPrice: null, image: '../assets/img/role-9807-pink.jpg' 
//     },
...
//         id: 't23', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 918-4", ru: "Детский самокат 918-4", en: "Kids Scooter 918-4" }, 
//         price: 1300, oldPrice: null, image: '../assets/img/scooter-918-4.jpg' 
//     },
//     { 
//         id: 't24', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii 999", ru: "Детский самокат 999", en: "Kids Scooter 999" }, 
//         price: 500, oldPrice: null, image: '../assets/img/scooter-999.jpg' 
//     },
//     { 
//         id: 't25', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii A81", ru: "Детский самокат A81", en: "Kids Scooter A81" }, 
//         price: 599, oldPrice: null, image: '../assets/img/scooter-a81.jpg' 
//     },
//     { 
//         id: 't26', 
//         category: 'transport', 
//         title: { ro: "Trotinetă KREISS A7", ru: "Самокат KREISS A7", en: "Scooter KREISS A7" }, 
//         price: 999, oldPrice: 1199, image: '../assets/img/scooter-kreiss-a7.jpg' 
//     },
//     { 
//         id: 't27', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii M1", ru: "Детский самокат M1", en: "Kids Scooter M1" }, 
//         price: 550, oldPrice: null, image: '../assets/img/scooter-m1.jpg' 
//     },
//     { 
//         id: 't28', 
//         category: 'transport', 
//         title: { ro: "Trotinetă copii M6", ru: "Детский самокат M6", en: "Kids Scooter M6" }, 
//         price: 570, oldPrice: null, image: '../assets/img/scooter-m6.jpg' 
//     },
...
//         id: 't29', 
//         category: 'transport', 
//         title: { ro: "Trotinetă SCOOTER 5S WHITE", ru: "Самокат SCOOTER 5S WHITE", en: "Scooter 5S White" }, 
//         price: 1099, oldPrice: 1299, image: '../assets/img/scooter-5s-white.jpg' 
//     },
//     { 
//         id: 't30', 
//         category: 'transport', 
//         title: { ro: "Trotinetă SCOOTER Y5", ru: "Самокат SCOOTER Y5", en: "Scooter Y5" }, 
//         price: 999, oldPrice: 1199, image: '../assets/img/scooter-y5.jpg' 
//     },
...
//     { id: 'b1', category: 'barci', title: { ro: 'Piscină Prism Frame, 366×76 cm, 6503 L, pompă de filtrare, 2006 L/h', ru: 'Каркасный бассейн Prism Frame 366×76см, 6503л, фил.-насос 2006л/ч', en: 'Prism Frame pool, 366×76 cm, 6503 L, filter pump, 2006 L/h' }, price: 0, oldPrice: null, image: '' },
...
//     { id: 'sa74', category: 'swim-accessories', title: { ro: 'Mască Înot Panoramică Completă S/M', ru: 'Полнолицевая панорамная маска для плавания.S/M', en: 'Full Face Snorkel Mask S/M' }, price: 450, oldPrice: null, image: '../assets/img/mask-full-face-sm.jpg' },
